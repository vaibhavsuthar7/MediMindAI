...
Your task is to analyze patient-reported symptoms using evidence-based clinical reasoning.

INSTRUCTIONS:
1. Analyze the symptoms provided by the patient.
...
class SymptomAgent(BaseAgent):
    name = "symptom_agent"
    description = "Conversational symptom triage with urgency ranking using LLM API."
